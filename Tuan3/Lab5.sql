--cau 1--
go
CREATE FUNCTION Lab5C1 (@masp VARCHAR(50))
RETURNS VARCHAR(50)
AS
BEGIN
...
go
go
SELECT dbo.Lab5C1('SP01')
go

--Cau 2--
go
CREATE FUNCTION Lab5C2(@x INT, @y INT)
RETURNS MONEY
AS
BEGIN
...
go
go
SELECT dbo.Lab5C2(2016,2019)
go


--Cau 3--
go 
CREATE FUNCTION Lab5C3(@tenSanPham nvarchar(50), @nam int)
RETURNS int
AS
BEGIN
...
go
go
SELECT dbo.Lab5C3('Galaxy Note 11',2020)
go

--Cau 4--
go
CREATE FUNCTION dbo.Lab5C4(
    @ngay_bat_dau DATE,
    @ngay_ket_thuc DATE
)
RETURNS MONEY
...
go
go
SELECT dbo.Lab5C4('2018-01-01', '2020-12-31') AS TongGiaTriNhap;
go

--Cau 5--
go
CREATE FUNCTION Lab5C5(@tenHang NVARCHAR(20), @nam INT)
RETURNS MONEY
AS
BEGIN
...
go
go
SELECT dbo.Lab5C5(N'Samsung', 2020) AS 'TongGiaTriXuat';
go

--Cau 6--
go
CREATE FUNCTION Lab5C6 (@tenPhong NVARCHAR(30))
RETURNS TABLE
AS
RETURN
...
go
go
SELECT * FROM Lab5C6(N'Kế toán')
go

--Cau 7--
go
CREATE FUNCTION Lab5C7(@ten_sp NVARCHAR(20), @ngay_xuat DATE)
RETURNS INT
AS
BEGIN
...
go
go
SELECT dbo.Lab5C7('OPPO', '2020-06-14')
go

--cau 8--
go
CREATE FUNCTION Lab5C8 (@sohdx NCHAR(10))
RETURNS NVARCHAR(20)
AS
BEGIN
...
go
go
SELECT dbo.Lab5C8('X02')
go

--cau9--
go
CREATE FUNCTION Lab5C9(@tenSP NVARCHAR(20), @nam INT)
RETURNS INT
AS
BEGIN
...
go
go
SELECT dbo.Lab5C9('Galaxy V21', 2020) AS TongNhapXuat;
go

--cau10--
go
CREATE FUNCTION Lab5C10(@tenhang NVARCHAR(20))
RETURNS INT
AS
BEGIN
    DECLARE @soluong INT;
...
go
go
SELECT dbo.Lab5C10('OPPO') AS 'Tổng số lượng sản phẩm của hãng'
go
